...
description: Polir l'expérience avec animations, sons et effets visuels
---
...
### Animation au défilement (scroll-driven)
...
<div class="keyboard">
  ...
  <button on:click={() => playTone(293.66)}>Ré</button>
