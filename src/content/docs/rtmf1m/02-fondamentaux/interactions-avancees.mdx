...
description: Aller au-delà du clic avec drag & drop, gestes et clavier
---
...
### Séquence de touches (Konami code)
...
- [Recette : Détection de gestes](/rtmf1m/recettes/02-interactions/detection-gestes)
