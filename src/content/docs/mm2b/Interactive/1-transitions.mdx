...
Expérimentez avec les transitions en ajustant les paramètres :

<LiveCodeEditor example="mm2b/cours-4-interactivite/hover-playground" height="800px" />
...
Comparez visuellement les différentes timing functions :

<LiveCodeEditor example="mm2b/cours-4-interactivite/timing-functions-demo" height="850px" />
...
### Exemples de boutons avec transitions
