...
Testez tous les états interactifs (hover, focus, active, disabled, checked...) :

<LiveCodeEditor example="mm2b/cours-4-interactivite/etats-demo" height="900px" />
