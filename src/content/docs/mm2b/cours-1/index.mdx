...
Bienvenue dans le premier cours du MM2B ! Dans ce cours, vous allez apprendre à structurer votre site d'histoires de manière accessible et sémantique.

### Durée estimée
⏱️ **4 heures** (2h de théorie + 2h de pratique)
...
Commencez par la première section pour comprendre pourquoi l'accessibilité est si importante dans le développement web.
