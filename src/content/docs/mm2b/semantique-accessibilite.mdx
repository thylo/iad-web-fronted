...
Dans ce cours, nous allons voir concrètement comment appliquer ces principes.
...
<LiveCode example="mm2b/cours-1-semantique/structure-complete" height="600px" />
...
<LiveCode example="mm2b/cours-1-semantique/site-histoire" height="700px" />
