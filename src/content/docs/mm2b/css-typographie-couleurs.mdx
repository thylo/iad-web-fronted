...
<div style={{ padding: '1.5rem', backgroundColor: '#FFF9E6', borderRadius: '1rem', marginBottom: '1rem' }}>
  <h3 style={{ fontSize: '2rem', fontWeight: 700, color: '#FF6B6B', marginBottom: '0.5rem', fontFamily: 'system-ui, -apple-system, sans-serif' }}>Les Aventures de Léo 🦁</h3>
  <p style={{ fontSize: '18px', lineHeight: 1.8, color: '#2C3E50', fontFamily: 'system-ui, -apple-system, sans-serif' }}>Il était une fois un petit lion qui adorait explorer la savane. Chaque jour, il découvrait de nouvelles merveilles et se faisait plein d'amis. Les lettres sont grandes et arrondies pour faciliter la lecture.</p>
</div>
