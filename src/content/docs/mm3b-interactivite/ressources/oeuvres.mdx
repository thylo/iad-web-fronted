...
### Exhausting a Crowd
**Type :** Installation interactive web
**Lien :** [exhaustingacrowd.com](https://www.exhaustingacrowd.com/)
**Description :** Expérience collaborative où chaque visiteur contribue à créer une œuvre collective qui s'épuise progressivement.
**Pourquoi l'analyser :** Participation collective et concept de finitude dans une œuvre infinie en potentiel.
