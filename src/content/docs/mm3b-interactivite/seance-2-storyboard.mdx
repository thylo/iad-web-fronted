...
- **[Les structures narratives](/ressources/structures-narratives)** - 6 structures (linéaire, élastique, concentrique, parallèle, embranchements, constellation)
- **[Les types d'interfaces](/ressources/interfaces-narratives)** - 8 archétypes (point-and-click, scrollable, timeline, écrans partagés, galeries, environnements 3D, cartes, gestuelles)
